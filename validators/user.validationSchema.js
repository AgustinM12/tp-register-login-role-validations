...
export const createUserSchema = [
  ...
  body('password')
    ...
    .isStrongPassword({ minLength: 5, minNumbers: 1, minUppercase: 1, minSymbols:0 }).withMessage("The passoword must have at least 5 characters, 1 uppercase, and 1 number"),
  body('email')
    .exists()
